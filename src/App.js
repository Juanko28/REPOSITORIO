...
function App() {
  ...
  return(
    <div className="estilo">
      <h1>REGISTRO DE PROOVEDOR</h1>
      {submitting &&
       <div>
         Informaciòn de provedor registrada:
         <ul>
      ...
      <form onSubmit={handleSubmit}>
        <fieldset>
          <label>
            <p>Razòn Social</p>
            <input name="Rsocial" onChange={handleChange}/>
          </label>
          <label>
            <p>Nombre Comercial</p>
            <input name="ncomer" onChange={handleChange2}/>
          </label>
          ...
          <label>
            ...
            <input name="contac" onChange={handleChange4}/>
          </label>
          <label>
            <p>Telefono/Celular</p>
            <input name="cell" onChange={handleChange5}/>
          </label>
        </fieldset>
